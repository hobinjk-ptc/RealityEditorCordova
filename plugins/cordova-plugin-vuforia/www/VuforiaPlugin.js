...
var VuforiaPlugin = {
  ...
  /** 07
   * Get projection matrix from Vuforia.
   *
   * @param {function} successCallback A callback for when the matrix is retrieved successfully. Passes a matrix in comma-separated string format.
   * @param {function|null} errorCallback A callback for when an error occurs.
   */
  getProjectionMatrix: function(successCallback, errorCallback){
    VuforiaPlugin.exec(successCallback, errorCallback, 'cordovaGetProjectionMatrix', []);
  },
